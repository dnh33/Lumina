...
| # | Item | Status |
|---|------|--------|
| 1 | Mood / door soup quarantine | **DONE · LIVE** — doors = linear tone rows; mood ≤8 high-signal (no pill parade) |
| 2 | Stage-gap rhythm tokens | **DONE · LIVE** — `--worlds-gap-{tight,cluster,stage}`; Hub cluster 12 / stage 20 / tight 10; closed fold ~1.20 |
| 3 | Hero dead-path `mist-400` residual | DONE (prior W3) |
| 4 | Self Featured “Inspect pane” copy | DONE (prior W3) |
| 5 | Shell `transition-all` → listed props | DONE (prior W3) |
| 6 | S4/S5 a11y shortlist | DONE (prior W3) |
